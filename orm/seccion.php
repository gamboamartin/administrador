...
class seccion extends modelo{
    ...
    public function alta_bd(): array
    {
        ...
        if(isset($r_alta_bd['error'])){
            return $this->error->error('Error al dar de alta seccion',$r_alta_bd);
        }
        ...
        foreach($columnas as $columna){
            ...
            $elemento_lista_ins['seccion_menu_id'] = $r_alta_bd['registro_id'];
            ...
            if(isset($r_elemento_lista['error'])){
                return $this->error->error('Error al dar de alta elemento lista',$r_elemento_lista);
            }
            $orden++;
        }
