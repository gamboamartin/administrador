...
class modeloTest extends test {
    ...
    public function test_genera_sql_filtro(): void
    {
        ...
        $this->assertIsString( $resultado);
        $this->assertNotTrue(errores::$error);
        $this->assertEquals('SELECT adm_seccion.id AS id, adm_seccion.codigo AS codigo, adm_seccion.descripcion AS descripcion, adm_seccion.status AS status, adm_seccion.usuario_alta_id AS usuario_alta_id, adm_seccion.usuario_update_id AS usuario_update_id, adm_seccion.fecha_alta AS fecha_alta, adm_seccion.fecha_update AS fecha_update, adm_seccion.descripcion_select AS descripcion_select, adm_seccion.alias AS alias, adm_seccion.codigo_bis AS codigo_bis, adm_seccion.predeterminado AS predeterminado, adm_seccion.adm_menu_id AS adm_menu_id, adm_seccion.adm_namespace_id AS adm_namespace_id, adm_seccion.etiqueta_label AS etiqueta_label, adm_seccion.icono AS icono,(SELECT COUNT(*) FROM adm_accion WHERE adm_accion.adm_seccion_id = adm_seccion.id) AS adm_seccion_n_acciones FROM adm_seccion AS adm_seccion LEFT JOIN adm_menu AS adm_menu ON adm_menu.id = adm_seccion.adm_menu_id LEFT JOIN adm_namespace AS adm_namespace ON adm_namespace.id = adm_seccion.adm_namespace_id WHERE ((x))',$resultado);
