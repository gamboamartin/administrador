...
class columnasTest extends test {
    ...
    public function test_columnas_base(){
        ...
        $this->assertIsString($resultado);
        $this->assertNotTrue(errores::$error);
        $this->assertEquals('adm_seccion.id AS id, adm_seccion.descripcion AS descripcion, adm_seccion.etiqueta_label AS etiqueta_label, adm_seccion.status AS status, adm_seccion.adm_menu_id AS adm_menu_id, adm_seccion.icono AS icono, adm_seccion.fecha_alta AS fecha_alta, adm_seccion.fecha_update AS fecha_update, adm_seccion.usuario_alta_id AS usuario_alta_id, adm_seccion.usuario_update_id AS usuario_update_id, adm_seccion.codigo AS codigo, adm_seccion.codigo_bis AS codigo_bis, adm_seccion.descripcion_select AS descripcion_select, adm_seccion.alias AS alias, adm_seccion.adm_namespace_id AS adm_namespace_id, adm_seccion.predeterminado AS predeterminado, adm_campo.id AS adm_campo_id, adm_campo.descripcion AS adm_campo_descripcion, adm_campo.observaciones AS adm_campo_observaciones, adm_campo.status AS adm_campo_status, adm_campo.usuario_alta_id AS adm_campo_usuario_alta_id, adm_campo.usuario_update_id AS adm_campo_usuario_update_id, adm_campo.fecha_alta AS adm_campo_fecha_alta, adm_campo.fecha_update AS adm_campo_fecha_update, adm_campo.adm_tipo_dato_id AS adm_campo_adm_tipo_dato_id, adm_campo.adm_seccion_id AS adm_campo_adm_seccion_id, adm_campo.sub_consulta AS adm_campo_sub_consulta, adm_campo.codigo AS adm_campo_codigo, adm_campo.descripcion_select AS adm_campo_descripcion_select, adm_campo.codigo_bis AS adm_campo_codigo_bis, adm_campo.predeterminado AS adm_campo_predeterminado, adm_campo.es_foranea AS adm_campo_es_foranea, adm_mes.id AS adm_mes_id, adm_mes.descripcion AS adm_mes_descripcion, adm_mes.codigo AS adm_mes_codigo, adm_mes.status AS adm_mes_status, adm_mes.usuario_alta_id AS adm_mes_usuario_alta_id, adm_mes.usuario_update_id AS adm_mes_usuario_update_id, adm_mes.fecha_alta AS adm_mes_fecha_alta, adm_mes.fecha_update AS adm_mes_fecha_update, adm_mes.codigo_bis AS adm_mes_codigo_bis, adm_mes.descripcion_select AS adm_mes_descripcion_select, adm_mes.alias AS adm_mes_alias, adm_mes.predeterminado AS adm_mes_predeterminado, adm_accion.id AS adm_accion_id, adm_accion.descripcion AS adm_accion_descripcion, adm_accion.etiqueta_label AS adm_accion_etiqueta_label, adm_accion.adm_seccion_id AS adm_accion_adm_seccion_id, adm_accion.status AS adm_accion_status, adm_accion.icono AS adm_accion_icono, adm_accion.visible AS adm_accion_visible, adm_accion.inicio AS adm_accion_inicio, adm_accion.lista AS adm_accion_lista, adm_accion.seguridad AS adm_accion_seguridad, adm_accion.usuario_update_id AS adm_accion_usuario_update_id, adm_accion.usuario_alta_id AS adm_accion_usuario_alta_id, adm_accion.fecha_alta AS adm_accion_fecha_alta, adm_accion.fecha_update AS adm_accion_fecha_update, adm_accion.es_modal AS adm_accion_es_modal, adm_accion.es_view AS adm_accion_es_view, adm_accion.titulo AS adm_accion_titulo, adm_accion.css AS adm_accion_css, adm_accion.es_status AS adm_accion_es_status, adm_accion.descripcion_select AS adm_accion_descripcion_select, adm_accion.codigo AS adm_accion_codigo, adm_accion.codigo_bis AS adm_accion_codigo_bis, adm_accion.alias AS adm_accion_alias, adm_accion.es_lista AS adm_accion_es_lista, adm_accion.muestra_icono_btn AS adm_accion_muestra_icono_btn, adm_accion.muestra_titulo_btn AS adm_accion_muestra_titulo_btn, adm_accion.id_css AS adm_accion_id_css', $resultado);
